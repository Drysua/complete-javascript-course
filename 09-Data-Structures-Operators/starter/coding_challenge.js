...
for (const [i, name] of game.scored.entries()) console.log(i, name);
let avg = 0;
...
for (const [key, value] of Object.entries(game.odds)) {
  console.log(`Odd of ${game?.[key] ? 'victory' : 'draw'} : ${value}`);
}
